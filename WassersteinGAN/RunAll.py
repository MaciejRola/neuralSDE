...
if not os.path.exists('Results/WassersteinGAN_NeuralLV.pth.tar'):
...
if not os.path.exists('Results/WassersteinGAN_NeuralLSV.pth.tar'):
...
if not os.path.exists('Results/WassersteinGAN_NeuralSDE.pth.tar'):
